...
const jsonLd = {
  ...
  '@graph': [
    ...
    },
    {
      ...
      hasPart: [
        { '@type': 'AboutPage', name: 'About Pau', url: 'https://pauuu.dev/about' },
        { '@type': 'WebPage', name: 'Services', url: 'https://pauuu.dev/services' },
        { '@type': 'CollectionPage', name: 'Portfolio', url: 'https://pauuu.dev/portfolio' },
        { '@type': 'WebPage', name: 'Skills', url: 'https://pauuu.dev/skills' },
