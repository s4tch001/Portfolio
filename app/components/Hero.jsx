          ...
          <div className='hero__card'>
            ...
            <pre className='hero__code'>
              <code>
                ...
                {'\n'} stack: [<span className='tk-str'>'JavaScript'</span>,{' '}
                <span className='tk-str'>'React'</span>,{' '}
                <span className='tk-str'>'Vite'</span>,{' '}
                <span className='tk-str'>'Supabase'</span>],
                {'\n'} edge: [<span className='tk-str'>'Workers'</span>,{' '}
                <span className='tk-str'>'D1'</span>,{' '}
                <span className='tk-str'>'R2'</span>],
                {'\n'} shipsTo: [<span className='tk-str'>'Netlify'</span>,{' '}
